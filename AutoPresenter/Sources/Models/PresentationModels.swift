...
struct PresentationDeck: Sendable {
    ...
    func instructionBlock(currentSlideIndex: Int) -> String {
        ...
        var parts: [String] = [
            ...
            "Emit one object with key commands=[...]. commands must be an ordered array of atomic actions for this turn.",
            ...
            "Use mark for intermediate feedback when speech matches numbered segments on the current slide.",
